...
**An experiential learning framework that replaces traditional government exams with hands-on civic engagement.**

[![GitHub Pages](https://img.shields.io/badge/Live%20Site-GitHub%20Pages-blue)](https://yourusername.github.io/civic-action-project)
...
**Created by Jared Stewart**
Government Faculty, Tarrant County College · Fort Worth, TX
EdD Candidate, Educational Technology Leadership · Tarleton State University
...
| [**Video Introduction Assignment**](Video_Introduction_Assignment.docx) | "Government & Me" Week 1 discussion board icebreaker |
| [**Pre/Post Survey**](CAP_Reflection_Survey.pdf) | Civic engagement outcome measurement instrument |
...
1. Visit the [live site](https://yourusername.github.io/civic-action-project) to browse and download resources
2. Start with the **Implementation Guide** for the full picture
3. Follow **Canvas Setup Instructions** to configure your LMS
4. Use the **CAP Tracker** to manage student progress across sections
...
CAP is grounded in:
- **Self-Determination Theory** (Deci & Ryan) — student autonomy through choice-based design
...
These materials are shared as an **Open Educational Resource**. You are free to use, adapt, and distribute them with attribution.
...
- 🏛️ [Tarrant County College](https://www.tccd.edu)
